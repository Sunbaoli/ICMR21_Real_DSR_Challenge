...
class Net(nn.Module):
    def __init__(self, num_channels, base_filter, feat, num_stages, scale_factor):
        ...
        self.down4 = DownBlock(2*base_filter, base_filter, kernel, stride, padding)
        ...
        self.input_lr2 = ConvBlock(base_filter, num_channels, kernel, stride, padding, activation=None, norm=None)
    ...
    def forward(self,  x, color):
        ...
        d1 = self.out_depth1(concat_5)
        # d2 = self.out_depth2(d1)
        d = self.output_depth_conv(d1)

        sr1 = self.out_SR1(concat_5)
        ...
        return d, sr#, grad1, grad2, gt_grad#, input_lr2
