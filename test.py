...
parser.add_argument('--gpu', type=int, default=1, help='the number of using gpu')
# Networks
parser.add_argument('--model_type', type=str, default='edsrx2_v3')
parser.add_argument('--upscale_factor', type=int, default=2, help="super resolution upscale factor")
parser.add_argument('--weights', default="./ubunEDSRx2v3edsrc2_v3_epoch_109.pth", help='sr pretrained base model')
# Data
parser.add_argument('--data_dir', type=str, default='../data/', help='root of data')
parser.add_argument('--test_dataset', type=str, default='Stage1/', help='')
parser.add_argument('--output_dir', default='result_submission/', help='Location to save the prediction')
...
test_set = get_eval_set(opt.data_dir, opt.test_dataset)
testing_data_loader = DataLoader(dataset=test_set, num_workers=opt.threads, batch_size=opt.testBatchSize, shuffle=False)

print('===> Building model')
if opt.model_type == 'edsrx2_v3':
    model = edsrx2_v3(num_channels=1, base_filter=64, feat=256, num_stages=4, scale_factor=opt.upscale_factor)
